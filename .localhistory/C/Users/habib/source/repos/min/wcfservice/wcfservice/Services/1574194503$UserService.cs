...
using SDK.IServices;
using SDK;
using wcfservice.Lib.Pagination;
...
namespace wcfservice.Services
{
     ...
     */
        ...
        public List<User> GetAllUsers(int page = 1,int pagesize=30)
        {
            return db.Users.OrderBy(u=>u.ID).GetPaged<User>(page, pagesize).Results.ToList();
        }
