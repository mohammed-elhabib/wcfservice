...
{
    public class EditUserViewModel : DialogViewModelBase<User>
    {
        ...
        public EditUserViewModel(User user,string title, ContentControl dailogcontent) : base(title, dailogcontent)
        {
            this._user = user;
